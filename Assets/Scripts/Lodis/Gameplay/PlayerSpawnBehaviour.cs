...
namespace Lodis.Gameplay
{
    public class PlayerSpawnBehaviour : MonoBehaviour
    {
        ...
        private void LoadAIDecisions()
        {
            ...
            AIAgentBehaviour dummyController = BlackBoardBehaviour.Instance.Player2Controller as AIAgentBehaviour;
            //dummyController.LoadDecisions();

            if (_mode == GameMode.SIMULATE)
            {
                dummyController = BlackBoardBehaviour.Instance.Player1Controller as AIAgentBehaviour;
                //dummyController.LoadDecisions();
            }
        }
